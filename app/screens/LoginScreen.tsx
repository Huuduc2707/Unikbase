  ...
  return (
    <Screen style={$root} preset="fixed">
      ...
      <View style={$textContainer}>
            ...
            <Text style={$instructionText} text="Create your account or sign into an existing account to build and manage your digital twins."/>
      </View>

      {/* Button zone */}
      <View style={$buttonContainer}>
        <Button style={$createAccountButton} text="CREATE ACCOUNT" textStyle={$createAccountText} pressedStyle={$buttonPressed}/>
