...
interface LinkNfcTagScreenProps extends NativeStackScreenProps<AppStackScreenProps<"LinkNfcTag">> {}

export const LinkNfcTagScreen: FC<LinkNfcTagScreenProps> = observer(function LinkNfcTagScreen() {
  ...
  return (
    <Screen style={$root} preset="fixed">
      ...
      <View style={$headerContainer}>
        ...
        <Text style={$title} tx={"mainpageNavigator.tabName.linkNFCTag"} />
      </View>

      {/* Main content */}
      <View style={$bodyContainer}>
        <TouchableOpacity activeOpacity={0.7} onPress={() => navigation.navigate("NfcLink")}>
          <Text style={$scanButton} tx={"mainpageNavigator.more.scanNFCTag.readyToScan"} />
        </TouchableOpacity>
        <Image
          style={$image}
          source={require("../../assets/images/scanNFCTag.png")}
          resizeMode="contain"
        />
